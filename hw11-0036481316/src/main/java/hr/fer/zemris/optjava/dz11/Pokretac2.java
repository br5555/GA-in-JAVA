...
import hr.fer.zemris.optjava.generic.ga.GeneticAlgh2;
import hr.fer.zemris.optjava.generic.ga.Mutation;
import hr.fer.zemris.optjava.generic.ga.Selection;
import hr.fer.zemris.optjava.rng.RNG;
/**
 * Class test impleemntation of {@linkplain GeneticAlgh2}.Program uses argument from command line
...
public class Pokretac2 {
	...
	public static void main(String[] args) {
		...
		GeneticAlgh2 algh = new GeneticAlgh2(sizeOfPop, numOfSquares, rng.getRNG(), maxIterat, 4, new Selection(), new Crossover(2, rng.getRNG()), new Mutation(2, rng.getRNG()), template);
