...
import hr.fer.zemris.optjava.dz7.pso.IFunction;
...
public class ClonAlg {
	...
	private Clone clone;
	/**
	 * Private insatnce of {@linkplain IHypermutation}
	 */
	 ...
	 * @param beta hyper parameter of cloning
	 * @param n size of population
	 * @param d size of new entities
	 * @param dim dimension of solution
	 * @param function instance of {@linkplain IFunction}
	...
	public void run() {
		...
		for(int i = 0; i< maxIter; i++){
			...
			if(antigenGlobal.getFitness() < maxError){
				...
				function.finalResult(antigenGlobal.getValues());
				return;
			}
	 ...
	 * @param numOfAntigens number of new Antigens
	 * @return new antigens
	 */
